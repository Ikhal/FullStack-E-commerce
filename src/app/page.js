      ...
      <section className="">
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            Discover a world of convenience and style at IbrahimBUY. We bring you an extensive 
            collection of top-notch products right to your fingertips, offering a seamless and 
            ...
            <button
              ...
              className="mt-1.5 inline-block bg-cyan-700 px-5 py-3 text-xs font-medium uppercase tracking-wide text-white"
            >
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img
              src="https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        ...
                        >
                          ...
                          <div className="mt-3">
                            ...
                            <p className="mt-1 text-sm text-gray-800">
                              ${productItem.price}{" "}
                              <span className="text-green-700">{`(-${productItem.priceDrop}%) Off`}</span>
                            </p>
                          </div>
                        </li>
                      ))
